...
.menu-btn{display:none;background:none;border:none;font-size:22px;cursor:pointer;color:var(--txt);padding:4px 8px;line-height:1}@media(max-width:768px){body{flex-direction:column}.menu-btn{display:block}.side{position:fixed;left:-280px;top:0;bottom:0;z-index:100;width:280px;transition:left .25s;box-shadow:2px 0 12px rgba(0,0,0,.15)}.side.open{left:0}.side-backdrop{display:none;position:fixed;inset:0;background:rgba(0,0,0,.35);z-index:99}.side-backdrop.show{display:block}.main{flex:1;min-height:0}.msgs{padding:12px 16px}.bubble{max-width:90%;font-size:13px}.inp{padding:10px 12px 14px}.inp textarea{height:44px;font-size:16px}.inp button{padding:0 14px;font-size:14px}.bar{height:52px;padding:0 12px;gap:8px}.bar .logo{font-size:15px}.bar button{font-size:10px;padding:4px 8px}.bar img{width:32px;height:32px}.overlay>div{width:92vw;max-width:460px;padding:20px;border-radius:10px}.welcome{margin-top:40px}.new-btn{margin:6px 10px 12px;font-size:13px;padding:10px}}</style></head><body>
<div class="side"><h2>雪峰Agent v2.3</h2><div class="sub">AI高考志愿顾问</div>
<div class="list" id="chatList"></div><div class="new-btn" id="newBtn">+ 新建对话</div></div><div class="side-backdrop" id="sideBackdrop"></div>
<div class="main"><div class="bar"><button class="menu-btn" id="menuBtn">☰</button><span class="logo">雪峰Agent</span>
...
<script>
function toggleSide(){var s=document.querySelector(".side");var b=document.getElementById("sideBackdrop");if(!s||!b)return;var o=s.classList.contains("open");if(o){s.classList.remove("open");b.classList.remove("show")}else{s.classList.add("open");b.classList.add("show")}}document.addEventListener("DOMContentLoaded",function(){var mb=document.getElementById("menuBtn");if(mb)mb.addEventListener("click",toggleSide);var bd=document.getElementById("sideBackdrop");if(bd)bd.addEventListener("click",toggleSide)});
